...
using SharpPizza.Application.Specifications;
using SharpPizza.Infrastructure.Specification;

namespace SharpPizza.Infrastructure.Persistence.Repositories
{
    public class RepositoryBase<T> : IAsyncRepository<T> where T : class
    {
        protected readonly SharpPizzaDbContext _context;

        public RepositoryBase(SharpPizzaDbContext context)
        {
            _context = context;
        }
